...
| Optional or detailed information | `` (Expandable) | Keeps page scannable while providing depth for interested readers |
...
| Visual navigation cards | `` | Creates clickable card grid for section navigation |
...
| Dynamic content | `` | Displays variable values that update automatically |
...
1. If SUMMARY.md doesn't exist - GitBook has inferred the structure from your directory layout. Browse the directory structure to understand how pages are organized.
2. Check .gitbook.yaml - Review this file to understand:

- Where the root documentation directory is located
- Any custom paths for README.md or SUMMARY.md
- Existing redirects

1. Explore .gitbook/assets/ - Contains all uploaded images and files referenced in the documentation
2. Check .gitbook/vars.yaml - Contains space-level variables if any are defined
...
Expressions allow you to reference and display variable values dynamically in your content. Expressions use JavaScript syntax and are wrapped in `` tags.
...
GET https://gitbook.com/docs/skill.md?ask=
